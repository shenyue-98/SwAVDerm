...
parser.add_argument("--jsonl_path", type=str, default="/path/to/jsonl",
                    help="path to jsonl dataset repository")
...
parser.add_argument("--dump_path", type=str, default="data/log",
                    help="experiment dump path for checkpoints and log")
parser.add_argument("--restart_path", type=str, default=".",
                    help="restart training path")
...
def main():
    ...
    if os.path.isfile(args.restart_path):
        logger.info("Restart checkpoint at {}".format(args.restart_path))
        # open checkpoint file
        state_dict = torch.load(
            args.restart_path, map_location="cuda:" + str(args.gpu_to_work_on)
        )
